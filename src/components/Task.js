...
function Task() {
    ...
    }, [projectId, isAddTaskModalOpen, isRenderChange, descrip]);

    const updateTodo = (data) => {
        axios.put(`https://capstone-project-management-be.onrender.com/project/${projectId}/todo`, data)
            .then((res) => {
            }).catch((error) => {
                toast.error('Something went wrong')
            })
    ...
    const handleDelete = (e, taskId) => {
        e.stopPropagation();
        axios.delete(`https://capstone-project-management-be.onrender.com/project/${projectId}/task/${taskId}`)
            .then((res) => {
    ...
    return (
        <>
            <Navbar />
            <div className='px-12 py-6 w-full d-flex justify-content-between'>
                <div className='px-3 py-2 mr-5'>
                    <Sidebar />
                </div>
                <div className='px-3 py-2 w-50 ml-5 mt-3'>
                    <h4>Project Description</h4><br />
                    <div>{descrip}</div>
                </div>
                <div className=' py-2 w-50 d-flex flex-column'>
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className=" w-full flex justify-between">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" width={15} height={15} className="text-[#9ba8bc]" viewBox="0 0 448 512"><path d="M120 256c0 30.9-25.1 56-56 56s-56-25.1-56-56s25.1-56 56-56s56 25.1 56 56zm160 0c0 30.9-25.1 56-56 56s-56-25.1-56-56s25.1-56 56-56s56 25.1 56 56zm104 56c-30.9 0-56-25.1-56-56s25.1-56 56-56s56 25.1 56 56s-25.1 56-56 56z" /></svg>
                                            </div>
                                            <div>
                                                    ...
                                                    {(provided, snapshot) => {
                                                        return (
                                                            <div
                                                                ...
                                                                className={`min-h-[530px] pt-4 duration-75 transition-colors border-t-2 border-gray-400 ${snapshot.isDraggingOver && 'border-indigo-600'}`}
                                                            >
